 ...
 * here allow you to send data to the azure cloud
 * 
...
static const char* connectionString = "HostName=ecen5013-hub.azure-devices.net;DeviceId=stm32;SharedAccessKey=7mkftzT8q0lgtuTkVyIzMM+jlq17contR8+nCAHUkoQ=";
